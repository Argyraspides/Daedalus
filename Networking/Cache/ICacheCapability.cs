...
namespace Daedalus.Networking.Cache;

public interface ICacheCapability<DaedalusResource>
{
    void CacheResource(DaedalusResource resource);
    DaedalusResource RetrieveResourceFromCache(string resourceHash);
    ...
    /// <returns></returns>
    DaedalusResource RetrieveResourceFromCache(DaedalusResource partialResource);

    bool ResourceExists(string resourceHash);
    bool ResourceExists(DaedalusResource partialResource);
}
